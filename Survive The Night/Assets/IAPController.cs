...
public class IAPController : MonoBehaviour, IStoreListener
{
    ...
    public void InitializePurchasing()
    {
        ...
        builder.AddProduct(Coins_300, ProductType.Consumable);
        builder.AddProduct(Coins_500, ProductType.Consumable);
        builder.AddProduct(Coins_750, ProductType.Consumable);
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        ...
        if (String.Equals(args.purchasedProduct.definition.id, Coins_100, StringComparison.Ordinal))
        {
            ...
            UserProfile.addCoins(100);
        }

        else if (String.Equals(args.purchasedProduct.definition.id, Coins_300, StringComparison.Ordinal))
        {
            Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
            UserProfile.addCoins(300);
        }

        else if (String.Equals(args.purchasedProduct.definition.id, Coins_500, StringComparison.Ordinal))
        {
            Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
            UserProfile.addCoins(500);
        }

        else if (String.Equals(args.purchasedProduct.definition.id, Coins_750, StringComparison.Ordinal))
        {
            Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
            UserProfile.addCoins(750);
        }
